...
from network_probe.core.port_parser import parse_port_spec, parse_exclude_ports
from network_probe.plugins.phantom_plugin_manager import PhantomPluginManager
from network_probe.plugins.plugin_manager import PluginManager
...
class PhantomCLI:
    ...
    def __init__(self):
        ...
        self.legacy_manager = PluginManager()  # For backward compatibility
    ...
    def print_banner(self):
        ...
        print(f"{Fore.YELLOW}Advanced network scanning tool with plugin-based architecture{Style.RESET_ALL}")
