...
class PhantomPluginManager:
    ...
    def __init__(self, plugin_base_dir: str = None):
        ...
        if plugin_base_dir is None:
            ...
            self.plugin_base_dir = current_dir
            self.plugin_module_prefix = "phantom_sweep.plugins"
        else:
            self.plugin_base_dir = plugin_base_dir
            self.plugin_module_prefix = plugin_base_dir.replace("/", ".").replace("\\", ".")
    ...
    def _load_plugins(self):
        ...
        for category in self.plugins.keys():
            ...
            for file in os.listdir(category_dir):
                ...
                module_name = f"{self.plugin_module_prefix}.{category}.{file[:-3]}"
