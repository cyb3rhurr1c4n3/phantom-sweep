...
-   **Service & version detection**: Thu thập banner, phân tích dịch vụ phổ biến. (làm nổi thì dùng AI cho tính năng này)
-   **OS fingerprinting**: Dựa trên TTL, Window Size, TCP/IP stack behavior. (làm nổi thì dùng AI cho tính năng này)
...
-   **Tích hợp AI**: tích hợp để khiến app trở nên smart, tích hợp vào OS fingerprinting, service and version detection, evasion ,...
